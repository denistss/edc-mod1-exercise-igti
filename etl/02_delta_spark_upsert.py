...
enemnovo = (
    ...
    .load("s3://datalake-denis-igti-edc-tf/staging-zone/enem")
)

print(enemnovo.count())
print(enemnovo.printSchema())
...
# enemvelho = DeltaTable.forPath(spark, "s3://datalake-denis-igti-edc-tf/staging-zone/enem")
